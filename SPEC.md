...
| UI | Tailwind CSS + in-app component library (`apps/web/src/app/ui`) | Fast mobile-first styling; lightweight hand-rolled components. Simple charts as plain SVG; rich interactive charts (zoom, multi-series, projections — e.g. the Today balance chart) use Chart.js (006) |
